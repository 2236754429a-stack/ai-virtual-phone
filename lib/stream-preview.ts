...
const MEDIA_DIRECTIVE_RE = /\[(?:代付请求|音乐分享|语音条|表情包|表情|贴纸|sticker|照片|红包|转账|位置|名片|音乐|礼物)\s*[:：][^\]\r\n]*\]/gi;
const INCOMPLETE_MEDIA_DIRECTIVE_RE = /\[(?:代付请求|音乐分享|语音条|表情包|表情|贴纸|sticker|照片|红包|转账|位置|名片|音乐|礼物)\s*[:：][^\]\r\n]*$/gi;
